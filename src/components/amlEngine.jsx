...
export function calculate6MonthRolling(
  donations,
  donorId,
...
export function checkThresholds(accumulatedUMA, umaConfig) {
  ...
  if (accumulatedUMA >= uma.threshold_identification_uma)
...
export const DOCUMENT_TYPES = {
  ...
  constancia_dueno_beneficiario: {
    label: "Constancia Dueño Beneficiario",
    required_for: ["fisica", "moral"],
  },
  identificacion_dueno_beneficiario: {
    label: "ID Dueño Beneficiario",
    required_for: [],
  },
...
export function checkDocumentCompleteness(
  ...
  const required = getRequiredDocuments(donorType, hasBeneficialOwner).map(
