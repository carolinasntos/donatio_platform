...
const sections = [
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Portal OSC",
            desc: "Para el equipo de cumplimiento de la organización. Gestión completa de donantes, donativos, alertas y avisos SAT.",
            color: "slate",
          },
          {
            name: "Portal Donante",
            desc: "Para los donantes. Permite registrarse, ver sus donativos y subir documentos requeridos.",
            color: "teal",
          },
          {
            name: "AppleSeed Admin",
            desc: "Para el equipo de AppleSeed. Supervisión multi-organización, tickets y métricas globales.",
            color: "violet",
          },
        ],
      },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            action:
              "Generar Plantilla SAT, capturar en portal SAT y registrar folio de acuse.",
          },
          {
            status: "blocked",
            label: "Bloqueado",
            ...
            action:
              "No se deben aceptar donativos. Consultar al área jurídica.",
          },
          {
            status: "incomplete",
            ...
            action:
              "Solicitar al donante que complete su información en el portal.",
          },
        ],
      },
    ],
    ...
    subsections: [
      {
        ...
        content: [
          {
            type: "text",
            body: "El Dashboard es la vista principal del Portal OSC. Muestra un resumen ejecutivo del estado de cumplimiento de toda la organización.",
          },
          {
            type: "list",
          ...
          {
            type: "text",
            body: "El Semáforo de Cumplimiento muestra cuántos donantes hay en cada estatus (OK, Identificación Reforzada, Obligación de Aviso, Bloqueados, Incompletos) con una barra de progreso visual.",
          },
          {
            type: "text",
            body: "La sección de Avisos SAT Pendientes muestra los casos próximos a vencer con un contador de días restantes en color rojo (≤3 días), ámbar (≤7 días) o gris (más tiempo).",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            body: "La sección de Donantes permite registrar y gestionar el padrón completo de donantes de la OSC.",
          },
          {
            type: "list",
          ...
          {
            type: "text",
            body: "Se puede filtrar por estatus de cumplimiento, tipo de persona y buscar por nombre, RFC o email.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            body: "Registro de todos los donativos recibidos. Cada donativo se asocia a un donante y se calcula automáticamente su impacto en el acumulado de 6 meses.",
          },
          {
            type: "list",
          ...
          {
            type: "highlight",
            title: "Ventana móvil de 6 meses",
            body: "El sistema calcula el acumulado de cada donante en los 6 meses previos a la fecha de cada donativo (no el año fiscal). Esto significa que el umbral puede activarse en cualquier momento del año.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            body: "El expediente digital contiene todos los documentos requeridos para el proceso de Conoce a tu Cliente (KYC) de cada donante.",
          },
          {
            type: "list",
          ...
          {
            type: "text",
            body: "Los documentos se verifican manualmente por el equipo de cumplimiento. Una vez que todos los documentos requeridos están verificados y vigentes, el KYC se marca como 'Completo'.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            body: "Esta sección gestiona los casos de obligación de aviso al SAT. Un caso se crea automáticamente cuando un donante supera el umbral de 3,210 UMAs acumuladas en 6 meses.",
          },
          {
            type: "steps",
            ...
            items: [
              {
                step: "1",
                label: "Pendiente",
                desc: "El caso fue creado automáticamente. Revisar datos del donante.",
              },
              {
                step: "2",
                label: "En Preparación",
                desc: "El equipo está recopilando información y preparando el aviso.",
              },
              {
                step: "3",
                label: "Capturado en SAT",
                desc: "La información fue capturada en el portal del SAT.",
              },
              {
                step: "4",
                label: "Presentado",
                desc: "El aviso fue presentado. Se registra el folio SAT y se sube el acuse.",
              },
              {
                step: "5",
                label: "Cerrado",
                desc: "El caso está completamente resuelto y archivado.",
              },
            ],
          },
          {
            type: "highlight",
            title: "Plazo legal",
            body: "El aviso debe presentarse a más tardar el día 17 del mes siguiente a aquel en que se superó el umbral. El sistema muestra el countdown en tiempo real y cambia a rojo cuando hay riesgo de incumplimiento.",
          },
          {
            type: "text",
            body: "La Plantilla SAT es un formulario pre-llenado con todos los datos del donante y el donativo que activa el aviso. Se puede copiar o descargar como CSV para facilitar la captura en el portal del SAT.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            body: "El sistema genera alertas automáticas para todos los eventos que requieren atención del equipo de cumplimiento.",
          },
          {
            type: "alerts-table",
            items: [
              {
                type: "threshold_notice",
                severity: "high",
                label: "Umbral Obligación de Aviso",
                desc: "El donante superó 3,210 UMAs. Hay obligación legal de presentar aviso al SAT.",
              },
              {
                type: "threshold_identification",
                severity: "medium",
                label: "Umbral Identificación Reforzada",
                desc: "El donante superó 1,605 UMAs. Se debe completar identificación reforzada.",
              },
              {
                type: "cash_detected",
                severity: "critical",
                label: "Efectivo Detectado",
                desc: "Se registró un donativo en efectivo. Requiere documentación especial por LFPIORPI.",
              },
              {
                type: "incomplete_info",
                severity: "medium",
                label: "Información Incompleta",
                desc: "El expediente del donante tiene campos o documentos faltantes.",
              },
              {
                type: "notice_overdue",
                severity: "critical",
                label: "Aviso Vencido",
                desc: "El plazo del día 17 para presentar un aviso SAT ya venció.",
              },
              {
                type: "aviso_deadline_approaching",
                severity: "high",
                label: "Plazo Próximo",
                desc: "Quedan pocos días para presentar un aviso SAT.",
              },
              {
                type: "document_expired",
                severity: "medium",
                label: "Documento Vencido",
                desc: "Un documento del expediente del donante ha expirado.",
              },
              {
                type: "reputation_flag",
                severity: "high",
                label: "Riesgo Reputacional",
                desc: "El donante tiene una bandera de riesgo reputacional activa. Requiere revisión.",
              },
              {
                type: "risk_evaluation_pending",
                severity: "medium",
                label: "Evaluación de Riesgo Pendiente",
                desc: "No se ha realizado la evaluación de riesgo del donante.",
              },
            ],
          },
          {
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            body: "El Chatbot AML es un asistente con inteligencia artificial entrenado en la LFPIORPI y sus reglas de carácter general. Responde preguntas sobre cumplimiento, plazos, obligaciones y procedimientos.",
          },
          {
            type: "list",
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        body: "El Portal Donante está diseñado para que los donantes gestionen su propia información y documentación de forma autónoma, reduciendo la carga administrativa del equipo de cumplimiento de la OSC.",
      },
      {
        type: "list",
      ...
      },
      {
        ...
        body: "El donante solo ve su propia información. Los datos son compartidos con la OSC correspondiente. La OSC verifica y valida los documentos subidos por el donante.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "text",
        body: "El Portal Admin es exclusivo para el equipo interno de AppleSeed. Permite supervisar todas las organizaciones registradas en la plataforma desde un único panel.",
      },
      {
        type: "list",
    ...
    content: [
      {
        ...
        items: [
          {
            term: "AML",
            def: "Anti-Money Laundering. Conjunto de leyes, regulaciones y procedimientos para prevenir el lavado de dinero.",
          },
          {
            term: "LFPIORPI",
            def: "Ley Federal para la Prevención e Identificación de Operaciones con Recursos de Procedencia Ilícita. La ley mexicana que regula las actividades vulnerables.",
          },
          {
            term: "UMA",
            def: "Unidad de Medida y Actualización. Referencia económica publicada por el INEGI que se actualiza anualmente.",
          },
          {
            term: "KYC",
            def: "Know Your Customer / Conoce a tu Cliente. Proceso de verificación de identidad y documentación de los clientes o donantes.",
          },
          {
            term: "PEP",
            def: "Persona Políticamente Expuesta. Funcionario público o persona con influencia política que requiere due diligence reforzado.",
          },
          {
            term: "Dueño Beneficiario",
            def: "Persona física que directa o indirectamente controla o se beneficia de una persona moral.",
          },
          {
            term: "Aviso SAT",
            def: "Reporte obligatorio que las OSC deben presentar al SAT cuando un donante supera el umbral de 3,210 UMAs acumuladas en 6 meses.",
          },
          {
            term: "Ventana Móvil 6M",
            def: "Cálculo de acumulados en los 6 meses previos a cada donativo. No es por año fiscal, sino móvil y continua.",
          },
          {
            term: "Umbral de Identificación",
            def: "1,605 UMAs acumuladas en 6 meses. Activa la obligación de identificación reforzada del donante.",
          },
          {
            term: "Umbral de Aviso",
            def: "3,210 UMAs acumuladas en 6 meses. Activa la obligación legal de presentar aviso al SAT a más tardar el día 17 del mes siguiente.",
          },
          {
            term: "OSC",
            def: "Organización de la Sociedad Civil. Incluye Asociaciones Civiles (A.C.), Sociedades Civiles (S.C.), Fundaciones e Institutos.",
          },
          {
            term: "RFC",
            def: "Registro Federal de Contribuyentes. Identificador fiscal único de personas físicas y morales en México.",
          },
          {
            term: "CURP",
            def: "Clave Única de Registro de Población. Identificador único de personas físicas en México.",
          },
        ],
      },
    ],
...
function ContentBlock({ block }) {
        ...
        {block.items.map((item) => (
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <div
                className={`w-3 h-3 rounded-full ${item.dot} flex-shrink-0`}
              />
  ...
  if (block.type === "alerts-table")
    return (
      <div className="space-y-2">
        {block.items.map((item) => (
          <div
            key={item.type}
            className="flex items-start gap-3 p-3 rounded-xl border border-slate-100 bg-white hover:bg-slate-50"
          >
            <span
              className={`text-xs font-semibold px-2 py-0.5 rounded-full border flex-shrink-0 ${severityColors[item.severity]}`}
            >
    ...
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`w-9 h-9 rounded-xl flex items-center justify-center ${colorMap[section.color] || colorMap.slate}`}
          >
        ...
        <div className="border-t border-slate-100 p-5 space-y-5">
          ...
          {section.subsections?.map((sub) => {
            ...
            return (
              ...
              >
                <button
                  onClick={() => setOpenSub(isSubOpen ? null : sub.title)}
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-violet-900 text-white px-6 py-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/65 text-sm leading-relaxed max-w-2xl">
            Guía completa de uso de la plataforma AppleSeed AML Compliance.
            Cubre todos los portales, funcionalidades, alertas, umbrales
            regulatorios y flujos de trabajo.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-4">
        ...
        <div className="text-center py-8 text-slate-400 text-xs">
          AppleSeed AML Compliance Platform · Versión 1.0 · 2026 · Todos los
          derechos reservados
        </div>
      </div>
    </div>
